...
public:
     void Operation()
     {
          cout<<"Not decoratored, just a ConcreteComponent"<<endl;
     }
};
...
int main()
{
     ...
     pDecoratorAOjb->Operation();  // 调用: A装饰器 ---> 原Component
     cout<<"============================================="<<endl;
     Decorator *pDecoratorBOjb = new ConcreteDecoratorB(pComponentObj);
     pDecoratorBOjb->Operation();  // 调用: B装饰器 ---> 原Component
     cout<<"============================================="<<endl;
     Decorator *pDecoratorBAOjb = new ConcreteDecoratorB(pDecoratorAOjb);
     pDecoratorBAOjb->Operation(); // 调用: B装饰器 ---> A装饰器 ---> 原Component
     cout<<"============================================="<<endl;
